...
public class week_macro_protein extends Fragment {
    ...
    public week_macro_protein(Context context)
    {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.week_macro_protein_layout, container, false);
    ...
    {
        calorie_barChart = view.findViewById(R.id.week_inner_protein_bar);
        ...
        Float cal_values[] = insertCSV.get_past7_days_protein(past7days_strings);

        // creating a new bar data set.
        calorie_barDataset = new BarDataSet(getCalorieBarEntry(cal_values), "Protein");
        ...
        String calgoals  = pref.getFloat("Goal_Protein",0)+"";
        ...
        TextView average_intake = view.findViewById(R.id.week_inner_protein_average);
