...
public class year_macro_fat extends Fragment {
    ...
    public year_macro_fat(Context context)
    {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.year_macro_fat, container, false);
    ...
    {
        calorie_barChart = view.findViewById(R.id.year_inner_fat_bar);
        ...
        Float cal_values[] = insertCSV.get_year_fat(this_year);
        ...
        TextView average_intake = view.findViewById(R.id.year_inner_fat_average);
