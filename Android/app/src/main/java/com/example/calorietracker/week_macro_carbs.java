...
public class week_macro_carbs extends Fragment {
    ...
    public week_macro_carbs(Context context)
    {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.week_macro_carbs_layout, container, false);
    ...
    {
        calorie_barChart = view.findViewById(R.id.week_inner_carbs_bar);
        ...
        Float cal_values[] = insertCSV.get_past7_days_carbs(past7days_strings);
        ...
        TextView average_intake = view.findViewById(R.id.week_inner_carbs_average);
