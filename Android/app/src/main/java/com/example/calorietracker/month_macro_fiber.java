...
public class month_macro_fiber extends Fragment {
    ...
    public month_macro_fiber(Context context)
    {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.month_macro_fiber_layout, container, false);
    ...
    {
        calorie_lineChart = view.findViewById(R.id.month_inner_fiber_bar);
        ...
        Float cal_values[] = insertCSV.get_month_fiber(current_month);
        ...
        calorie_linDataSet = new LineDataSet(getCalorieBarEntry(cal_values), "Fiber");
        ...
        TextView average_intake = view.findViewById(R.id.month_inner_fiber_average);
