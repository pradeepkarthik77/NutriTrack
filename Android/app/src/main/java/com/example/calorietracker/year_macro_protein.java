...
public class year_macro_protein extends Fragment {
    ...
    public year_macro_protein(Context context)
    {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.year_macro_protein, container, false);
    ...
    {
        calorie_barChart = view.findViewById(R.id.year_inner_protein_bar);
        ...
        Float cal_values[] = insertCSV.get_year_protein(this_year);
        ...
        TextView average_intake = view.findViewById(R.id.year_inner_protein_average);
