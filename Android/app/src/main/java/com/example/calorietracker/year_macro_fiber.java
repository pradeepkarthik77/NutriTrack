...
public class year_macro_fiber extends Fragment {
    ...
    public year_macro_fiber(Context context)
    {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.year_macro_fiber, container, false);
    ...
    {
        calorie_barChart = view.findViewById(R.id.year_inner_fiber_bar);
        ...
        Float cal_values[] = insertCSV.get_year_fiber(this_year);
        ...
        TextView average_intake = view.findViewById(R.id.year_inner_fiber_average);
