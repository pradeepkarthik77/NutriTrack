...
public class week_macro_vitc extends Fragment {
    ...
    public week_macro_vitc(Context context)
    {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.week_macro_vitc_layout, container, false);
    ...
    {
        calorie_barChart = view.findViewById(R.id.week_inner_vitc_bar);
        ...
        Float cal_values[] = insertCSV.get_past7_days_vitc(past7days_strings);

        // creating a new bar data set.
        calorie_barDataset = new BarDataSet(getCalorieBarEntry(cal_values), "Vitamin C");
        ...
        String calgoals  = pref.getFloat("Goal_Vitamin_C",0)+"";
        ...
        TextView average_intake = view.findViewById(R.id.week_inner_vitc_average);
        ...
        average_intake.setText("Average Daily Intake: "+formattedValue+"mg");
    }
