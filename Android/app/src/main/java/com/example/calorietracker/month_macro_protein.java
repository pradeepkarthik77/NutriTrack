...
public class month_macro_protein extends Fragment {
    ...
    public month_macro_protein(Context context)
    {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.month_macro_protein_layout, container, false);
    ...
    {
        calorie_lineChart = view.findViewById(R.id.month_inner_protein_bar);
        ...
        Float cal_values[] = insertCSV.get_month_protein(current_month);
        ...
        calorie_linDataSet = new LineDataSet(getCalorieBarEntry(cal_values), "Protein");
        ...
        TextView average_intake = view.findViewById(R.id.month_inner_protein_average);
