...
public class month_macro_vitc extends Fragment {
    ...
    public month_macro_vitc(Context context)
    {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.month_macro_vitc_layout, container, false);
    ...
    {
        calorie_lineChart = view.findViewById(R.id.month_inner_vitc_bar);
        ...
        Float cal_values[] = insertCSV.get_month_vitc(current_month);
        ...
        calorie_linDataSet = new LineDataSet(getCalorieBarEntry(cal_values), "Vitamin C");
        ...
        TextView average_intake = view.findViewById(R.id.month_inner_vitc_average);
