...
public class week_macro_fat extends Fragment {
    ...
    public week_macro_fat(Context context)
    {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.week_macro_fat_layout, container, false);
    ...
    {
        calorie_barChart = view.findViewById(R.id.week_inner_fat_bar);
        ...
        Float cal_values[] = insertCSV.get_past7_days_fat(past7days_strings);

        // creating a new bar data set.
        calorie_barDataset = new BarDataSet(getCalorieBarEntry(cal_values), "Fat");
        ...
        TextView average_intake = view.findViewById(R.id.week_inner_fat_average);
