...
public class month_macro_carbs extends Fragment {
    ...
    public month_macro_carbs(Context context)
    {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.month_macro_carbs_layout, container, false);
    ...
    {
        calorie_lineChart = view.findViewById(R.id.month_inner_carbs_bar);
        ...
        Float cal_values[] = insertCSV.get_month_carbs(current_month);
        ...
        calorie_linDataSet = new LineDataSet(getCalorieBarEntry(cal_values), "Carbs");
        ...
        String calgoals  = pref.getFloat("Goal_Carbs",0)+"";
        ...
        TextView average_intake = view.findViewById(R.id.month_inner_carbs_average);
