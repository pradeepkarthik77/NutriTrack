...
public class year_macro_vitc extends Fragment {
    ...
    public year_macro_vitc(Context context)
    {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.year_macro_vitc, container, false);
    ...
    {
        calorie_barChart = view.findViewById(R.id.year_inner_vitc_bar);
        ...
        Float cal_values[] = insertCSV.get_year_vitc(this_year);
        ...
        TextView average_intake = view.findViewById(R.id.year_inner_vitc_average);
        ...
        average_intake.setText("Average Monthly Intake: "+formattedValue+"mg");
    }
